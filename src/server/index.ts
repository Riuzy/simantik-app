...
// Serve execution artifacts (screenshots, videos, traces) from the storage directory
app.use('/storage', express.static(path.resolve(process.cwd(), 'storage'), { dotfiles: 'allow' }));
